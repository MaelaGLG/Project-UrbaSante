...
# You need to dowload the BPE dataset: https://www.insee.fr/fr/metadonnees/source/operation/s2077/bases-donnees-ligne
...
data/linking tables/liaison - carto communes/carto_communes.csv
