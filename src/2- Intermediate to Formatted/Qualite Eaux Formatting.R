...
# Import dataset
path_csv = file.path(project_folder, "data", "2- Intermediate Data", "Qualite_des_eaux_souterraines.csv")
...
path_export = file.path(project_folder, "data", "3- Formatted Data", "qualite_eaux_souterraines.xlsx")
