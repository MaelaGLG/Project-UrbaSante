...
path = file.path(project_folder, "data", "1- Raw Data", "Déterminant 5- Pollution Lumineuse", "Radiance")
...
path_export = file.path(project_folder, "data", "3- Formatted Data", "radiance.xlsx")
