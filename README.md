...
|                                        | Indicateur Ozone (SOMO35)                  | L'indicateur SOMO35 fournit au niveau de la France, à une résolution minimale d'Iris (INSEE), la somme annuelle de concentrations journalières de O3 supérieures à 35ppb pour l'année de référence 2023. L'extraction des données a été faite à partir de données provenant du site Geod'Ai.                                                                                                                                                                                                                                                                               |
...
|                                        | Sécheresse                                 | Cet indicateur mesure le risque de sécheresse en France pour 2024, avec une résolution minimale par commune. Il pondère le nombre de jours en alerte de sécheresse, vigilance renforcée ou crise. Les données sont issues d'observations météorologiques détaillées (data.gouv).                                                                                                                                                                                                                                                                                            |
